...
export const INDUSTRY_PRESETS: Record<Industry, IndustryPreset> = {
  ...
  beauty: {
    industry: "beauty",
    name: "Beauty & Salon",
    description: "Elegant, luxurious design for beauty salons and spas",
    colors: {
      primary: "#be185d",
      secondary: "#a21caf",
      accent: "#e879a4",
    ...
    suggestedSections: ["hero", "services", "gallery", "pricing", "team", "testimonials", "booking", "footer"],
    features: { stickyHeader: true, smoothScroll: true, animations: true },
  },
  ...
  automotive: {
    ...
    description: "Bold, high-performance design for car dealerships and auto services",
    colors: {
      primary: "#1e3a8a",
      secondary: "#dc2626",
      accent: "#f59e0b",
    ...
    suggestedSections: ["hero", "inventory", "services", "financing", "testimonials", "about", "contact", "footer"],
    features: { stickyHeader: true, smoothScroll: true, lazyLoading: true },
  },
  ...
  finance: {
    ...
    description: "Trustworthy, professional design for financial services",
    colors: {
      primary: "#0c4a6e",
      secondary: "#115e59",
      accent: "#0284c7",
    ...
    suggestedSections: ["hero", "services", "rates", "calculator", "testimonials", "security", "contact", "footer"],
    features: { stickyHeader: true, smoothScroll: true, cookieConsent: true },
  },
  ...
  construction: {
    ...
    description: "Strong, reliable design for construction and contracting companies",
    colors: {
      primary: "#d97706",
      secondary: "#374151",
      accent: "#f59e0b",
    ...
    suggestedSections: ["hero", "services", "projects", "process", "team", "testimonials", "quote", "footer"],
    features: { stickyHeader: true, smoothScroll: true, lazyLoading: true },
  },
  ...
  travel: {
    industry: "travel",
    name: "Travel & Tourism",
    description: "Vibrant, inspiring design for travel agencies and tour operators",
    colors: {
      primary: "#0369a1",
      secondary: "#059669",
      accent: "#f97316",
    ...
    suggestedSections: ["hero", "destinations", "packages", "experiences", "testimonials", "gallery", "booking", "footer"],
    features: { stickyHeader: true, animations: true, smoothScroll: true, lazyLoading: true },
  },

  photography: {
    industry: "photography",
    name: "Photography & Studio",
    description: "Minimal, image-focused design for photographers",
    colors: {
      primary: "#18181b",
      secondary: "#a1a1aa",
      accent: "#e4e4e7",
    ...
    suggestedSections: ["hero", "portfolio", "services", "about", "pricing", "testimonials", "contact", "footer"],
    features: { animations: true, smoothScroll: true, lazyLoading: true },
  },
